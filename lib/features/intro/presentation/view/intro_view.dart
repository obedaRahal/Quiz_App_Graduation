...
class _IntroViewBodyState extends State<_IntroViewBody> {
  ...
  Future<void> _nextPage({required bool isLastPage}) async {
    if (isLastPage) {
      debugPrint("its the last page cuz $isLastPage");
      await context.read<IntroCubit>().finishIntro();
      return;
  ...
  Future<void> _previousPage({required bool isFirstPage}) async {
    if (isFirstPage) return;
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: IntroBottomPanel(
                            ...
                            controller: _pageController,
                            pagesCount: _pages.length,
                            onNext: () => _nextPage(isLastPage: isLastPage),
                            onPrevious: () =>
                                _previousPage(isFirstPage: isFirstPage),
                            isPreviousEnabled: !isFirstPage,
