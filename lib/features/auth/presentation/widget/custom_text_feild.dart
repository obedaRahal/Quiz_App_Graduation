...
class CustomTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fieldFontSize = SizeConfig.text(compact ? 0.038 : 0.043);
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.symmetric(
            horizontal: SizeConfig.sw(0.035),
            vertical: SizeConfig.sh(compact ? 0.012 : 0.016),
          ),
          hintText: hint,
          counterText: "",
          hintStyle: TextStyle(
            color: AppPalette.greyMedium,
            fontFamily: AppFont.elMessiriRegular,
            fontSize: hintFontSize ?? fieldFontSize,
          ),
          suffixIcon: suffixIcon == null
              ? null
              : IconButton(
          ...
          icon: iconData == null
              ...
              : IconButton(
                  onPressed: onIconTap,
                  icon: Icon(iconData, size: compact ? 18 : 20),
                ),
