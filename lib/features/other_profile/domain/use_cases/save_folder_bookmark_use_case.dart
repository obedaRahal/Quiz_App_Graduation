...
class SaveFolderBookmarkUseCase {
  final OtherProfileRepository repository;

  const SaveFolderBookmarkUseCase(this.repository);

  Future<Either<Failure, FolderBookmarkActionEntity>> call(
    FolderBookmarkActionParams params,
  ) {
    debugPrint("============ SaveFolderBookmarkUseCase.call ============");
    debugPrint("→ params: {folderId: ${params.folderId}}");

    return repository.saveFolderBookmark(folderId: params.folderId);
  }
}