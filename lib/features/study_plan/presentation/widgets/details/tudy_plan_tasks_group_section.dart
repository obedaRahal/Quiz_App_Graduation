...
class StudyPlanTasksGroupSection extends StatelessWidget {
  ...
  final ValueChanged<StudyPlanDailyTaskEntity> onTaskTap;

  final ValueChanged<StudyPlanDailyTaskEntity> onTaskStatusToggle;

  final bool Function(int taskId)? isTaskUpdating;
              ...
              : Padding(
                  ...
                  child: tasks.isEmpty
                      ...
                      : Column(
                          children: tasks.map((task) {
                            final isUpdating =
                                isTaskUpdating?.call(task.id) ?? false;
