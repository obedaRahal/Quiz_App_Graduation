...
class StudyPlanTasksSearchField extends StatefulWidget {
  final String value;
  final ValueChanged<String> onChanged;
  final VoidCallback onClear;

  const StudyPlanTasksSearchField({
    super.key,
    required this.value,
  ...
  @override
  State<StudyPlanTasksSearchField> createState() =>
      _StudyPlanTasksSearchFieldState();
}

class _StudyPlanTasksSearchFieldState extends State<StudyPlanTasksSearchField> {
  ...
  @override
  void didUpdateWidget(covariant StudyPlanTasksSearchField oldWidget) {
