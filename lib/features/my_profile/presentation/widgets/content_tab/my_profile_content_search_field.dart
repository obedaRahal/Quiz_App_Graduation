...
class MyProfileContentSearchField extends StatefulWidget {
  final String value;
  final ValueChanged<String> onChanged;
  final VoidCallback onClear;

  const MyProfileContentSearchField({
    super.key,
    required this.value,
  ...
  @override
  State<MyProfileContentSearchField> createState() =>
      _MyProfileContentSearchFieldState();
}

class _MyProfileContentSearchFieldState
    extends State<MyProfileContentSearchField> {
  ...
  @override
  void didUpdateWidget(covariant MyProfileContentSearchField oldWidget) {
