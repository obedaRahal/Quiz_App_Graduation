...
//                                               style.defaultAssetPath,
//                                           fallbackIcon: style.fallbackIcon,
//                                           fallbackFaIcon: style.fallbackFaIcon,
//                                           fallbackColor: style.mainColor,
//                                         ),
...
//   final String? assetPath;
//   final IconData? fallbackIcon;
//   final FaIconData? fallbackFaIcon;
//   final Color fallbackColor;

//   const _SnackBarLeadingIcon({
//     required this.assetPath,
//     required this.fallbackIcon,
//     required this.fallbackFaIcon,
//     required this.fallbackColor,
//   });
...
//     if (fallbackFaIcon != null) {
//       fallbackWidget = FaIcon(fallbackFaIcon!, color: fallbackColor, size: 28);
//     } else {
//       fallbackWidget = Icon(
...
//     case AppValidationSnackBarType.hint:
//       return _SnackBarStyle(
//         mainColor: AppPalette.yellow,
//         fallbackFaIcon: FontAwesomeIcons.lightbulb,
...
void showValidationTopSnackBar(
  ...
  entry = OverlayEntry(
    builder: (_) {
      return _ValidationSnackBarOverlay(
        title: title,
        message: message,
        type: type,
        reason: reason,
...
class _ValidationSnackBarOverlay extends StatefulWidget {
  ...
  @override
  State<_ValidationSnackBarOverlay> createState() {
    return _ValidationSnackBarOverlayState();
  }
}
...
class _ValidationSnackBarOverlayState extends State<_ValidationSnackBarOverlay>
  ...
  bool get _hasExtraDetails {
    return _notEmpty(widget.reason) ||
        _notEmpty(widget.startsAt) ||
        _notEmpty(widget.endsAt);
  }
                                      ...
                                      Align(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: style.mainColor.withValues(
...
class _SnackBarDetailsBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: mainColor.withValues(alpha: isDark ? 0.12 : 0.07),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: mainColor.withValues(alpha: isDark ? 0.38 : 0.25),
          width: 1,
        ),
      ),
      child: Column(
        ...
        children: List.generate(details.length, (index) {
          ...
          return Padding(
            padding: EdgeInsets.only(bottom: isLast ? 0 : SizeConfig.h(0.004)),
            child: details[index],
          );
        }),
      ),
...
class _SnackBarLeadingIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor = isDark
        ? fallbackColor.withValues(alpha: 0.92)
        : fallbackColor;

    final Widget fallbackWidget;

    if (fallbackFaIcon != null) {
      fallbackWidget = FaIcon(fallbackFaIcon!, color: iconColor, size: 28);
    } else {
      fallbackWidget = Icon(
        fallbackIcon ?? Icons.info_outline_rounded,
        color: iconColor,
